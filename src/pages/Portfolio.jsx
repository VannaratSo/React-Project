...
const BusinessPortfolio = () => {
  return (
    <section className="min-h-screen portfolio text-white py-40 px-6 md:px-20 bg-white dark:bg-gray-800 transition-colors duration-300">
      <div className="text-center mb-16 text-dark dark:text-white">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">
        Business <span className="text-blue-400  font-semibold ">Portfolio</span>
        </h1>
        <p className="text-gray-300 max-w-3xl mx-auto text-lg text-gray-600 dark:text-gray-300">
      ...
      <div className="backdrop-blur-md border border-white/20 bg-dark/10 rounded-2xl p-8 mb-12 text-black dark:text-gray-300">
        <h2 className="text-2xl font-semibold mb-4">Company Overview</h2>
        <p className="text-gray-300 leading-relaxed text-gray-600 dark:text-gray-300"><span className="text-blue-500 font-bold ">Delightech Co,. Ltd </span>
        ...
        <p className="text-gray leading-relaxed mt-4">
          Our flagship product, <span className="font-bold text-blue-500">LUYLEUN</span>, is
      ...
      <div className="backdrop-blur-md  border border-white/20 bg-dark/10 rounded-2xl p-8 mb-12 text-black dark:text-gray-300">
        <h2 className="text-2xl font-semibold mb-4">Our Flagship Product: <span className="font-bold text-blue-500">LUYLEUN</span></h2>
        <p className=" mb-6">
