...
const LatestNews = () => {
  ...
  return (
    <section
      id="LatestNews"
      className="py-40 px-6 lg:px-20 text-center light:bg-gray-800 flex flex-col items-center bg-white dark:bg-gray-800 transition-colors duration-300"
    >
      <div className="flex justify-between items-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold text-dark dark:text-white uppercase">
          {t("headline", { ns: "lastnews" })}
